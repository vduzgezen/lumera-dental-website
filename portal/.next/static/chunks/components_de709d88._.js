...
"[project]/components/UploadButtons.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function UploadButtons(param) {
    let { caseId, label, accept, title, disabled } = param;
    _s();
    ...
    async function upload() {
        ...
        try {
            ...
            const kind = ext === "stl" ? "STL" : ext === "ply" ? "PLY" : ext === "obj" ? "OBJ" : "OTHER";
            fd.append("kind", kind);
            fd.append("file", file);
            const res = await fetch("/api/cases/".concat(caseId, "/files"), {
                method: "POST",
                body: fd
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                fileName: "[project]/components/UploadButtons.tsx",
                lineNumber: 64,
                columnNumber: 7
            }, this),
            ...
            disabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "This slot can’t be changed at the current stage."
            }, void 0, false, {
                fileName: "[project]/components/UploadButtons.tsx",
                lineNumber: 83,
                columnNumber: 9
...
_s(UploadButtons, "PvDNwjwO9A8sItze6YuV1cFawmo=", false, function() {
    return [
...
_c = UploadButtons;
var _c;
__turbopack_context__.k.register(_c, "UploadButtons");
...
function ProgressTracker(param) {
    ...
    async function goTo(idx) {
        ...
        const to = target === "DESIGN" ? "IN_DESIGN" : target === "MILLING_GLAZING" ? "IN_MILLING" : "SHIPPED";
        await fetch("/api/cases/".concat(caseId, "/transition"), {
            method: "POST",
            headers: {
            ...
            children: STAGES.map((s, i)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    className: [
                        ...
                        active ? "bg-white text-black border-white" : done ? "bg-white/20 text-white border-white/20" : "bg-white/10 text-white/70 border-white/10",
                        canAdvance ? "cursor-pointer" : "cursor-default"
                    ].join(" "),
                    disabled: !canAdvance,
                    title: canAdvance ? "Set stage to ".concat(s) : undefined,
...
"[project]/components/ActionsBar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function ActionsBar(param) {
    let { caseId, role, status } = param;
    _s();
    ...
    async function send(to) {
        ...
        setErr(null);
        try {
            const res = await fetch("/api/cases/".concat(caseId, "/transition"), {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
            ...
            setErr((e === null || e === void 0 ? void 0 : e.message) || "Action failed");
        } finally{
            setBusy(false);
        }
    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        fileName: "[project]/components/ActionsBar.tsx",
                        lineNumber: 58,
                        columnNumber: 9
                    }, this),
                    canDoctor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                disabled: busy,
                    ...
                    canLab && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                disabled: busy,
...
_s(ActionsBar, "oDsTlNXVtBlCIjv+LQugSmV9D2Q=");
_c = ActionsBar;
var _c;
...
"[project]/components/CommentsPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function CommentsPanel(param) {
    let { caseId, comments, canPost } = param;
    _s();
    ...
    async function submit() {
        ...
        setErr(null);
        try {
            const res = await fetch("/api/cases/".concat(caseId, "/comments"), {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
            ...
            setErr((e === null || e === void 0 ? void 0 : e.message) || "Failed to post");
        } finally{
            setBusy(false);
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                fileName: "[project]/components/CommentsPanel.tsx",
                lineNumber: 49,
                columnNumber: 7
            }, this),
            ...
            canPost && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CommentsPanel, "IJmKFyu0TvrGYngthmLXCk1OjNs=");
_c = CommentsPanel;
var _c;
...
function STLViewer(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "STLViewer.useEffect": ()=>{
            ...
            const light1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, 1);
            light1.position.set(1, 1, 1);
            scene.add(light1);
            const light2 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](0x888888);
            scene.add(light2);
            ...
            loader.load(url, {
                "STLViewer.useEffect": (geometry)=>{
                    ...
                    mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
                    scene.add(mesh);
                    const box = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box3"]().setFromObject(mesh);
            ...
            }["STLViewer.useEffect"], undefined, {
                "STLViewer.useEffect": (err)=>{
                    console.error("STL load failed", err);
                }
            }["STLViewer.useEffect"]);
            const controls = new (__turbopack_context__.r("[project]/node_modules/three/examples/jsm/controls/OrbitControls.js [app-client] (ecmascript)")).OrbitControls(camera, renderer.domElement);
...
_s(STLViewer, "8uVE59eA/r6b92xF80p7sH8rXLk=");
_c = STLViewer;
var _c;
...
//# sourceMappingURL=components_de709d88._.js.map