...
;
;
const ACCEPT_SCAN_EXT = new Set([
    ".stl",
    ".ply",
    ".obj"
]);
const MAX_SCAN_BYTES = 200 * 1024 * 1024; // 200MB
/** DentalCase may be named differently in Prisma client */ function getCaseModel(p) {
...
function chooseExtAndKind(originalName) {
...
async function POST(req) {
    try {
        ...
        const lower = originalName.toLowerCase();
        const ext = lower.lastIndexOf(".") !== -1 ? lower.slice(lower.lastIndexOf(".")) : "";
        if (!ACCEPT_SCAN_EXT.has(ext)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const caseModel = getCaseModel(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]);
        ...
        const fileName = `${Date.now()}-${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID()}${chosenExt}`;
        const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(uploadsRoot, fileName);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(fullPath, scanBuf);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4fda251._.js.map