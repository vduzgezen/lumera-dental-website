module.exports = [
"[project]/.next-internal/server/app/api/cases/[id]/stage/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/cases/[id]/stage/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    ...
    const model = getCaseModel(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]);
    ...
    if (currentStage === "DESIGN" && targetStage === "MILLING_GLAZING") {
        if (currentStatus !== "APPROVED") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Case must be APPROVED before moving to Milling & Glazing."
            }, {
                status: 400
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Case must go through Milling & Glazing before Shipping."
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7200eb45._.js.map