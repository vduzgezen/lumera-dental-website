...
const ACCEPT_SCAN = new Set([
    "stl",
    "ply",
    "obj"
]);
const ACCEPT_STL = new Set([
    "stl"
]);
...
async function POST(req, { params }) {
    ...
    if (session.role === "customer") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Forbidden"
    }, {
        status: 403
    });
    ...
    if (!LABELS.has(label)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid or missing label"
    }, {
        status: 400
    });
    if (!files || files.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "No files"
    }, {
        status: 400
    });
    ...
    if (label === "scan" && item.stage !== "DESIGN") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Scan cannot be replaced after Milling & Glazing starts"
        }, {
            status: 400
        });
    }
    const root = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", params.id);
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(root, {
        recursive: true
    });
    const created = [];
    for (const f of files){
        if (!(f instanceof File)) continue;
        if (f.size > MAX_SIZE) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (label === "scan" && !ACCEPT_SCAN.has(ext)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Scan must be STL/PLY/OBJ"
            }, {
                status: 400
            });
        }
        if ((label === "design_with_model" || label === "design_only") && !ACCEPT_STL.has(ext)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Design files must be STL"
            }, {
                status: 400
            });
        }
        ...
        const kindAny = [
            ...
            "PLY",
            "OBJ"
        ].includes(extUpper) ? extUpper : "OTHER";
        const name = `${Date.now()}-${__TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomUUID()}.${ext}`;
        const fullpath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(root, name);
        const buf = Buffer.from(await f.arrayBuffer());
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(fullpath, buf);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8204321f._.js.map