...
async function POST(req) {
    try {
        ...
        const orderDateIn = form.get("orderDate") || "";
        ...
        if (!doctor || doctor.role !== "customer" || !doctor.clinic) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Selected doctor is not valid or not linked to a clinic."
            }, {
                status: 400
            });
        }
        ...
        if (isNaN(orderDate.getTime())) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid order date. Use the date picker (YYYY-MM-DD)."
            }, {
                status: 400
            });
        }
        const dueDate = addDays(orderDate, 8);
        if (scanFile.size > MAX_SIZE) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Scan file is too large (max ~200MB)."
        }, {
            status: 413
        });
        ...
        const root = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", created.id);
        ...
        const buf = Buffer.from(await scanFile.arrayBuffer());
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Something went wrong creating the case. Please try again."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6611bc47._.js.map