...
// FIX: Consolidated "NEW/READY_FOR_REVIEW" into "IN_DESIGN"
...
export default function CaseDetailSidebar({
  ...
  const [activeTab, setActiveTab] = useState<"files" | "discussion" | "history" | null>(null);

  useEffect(() => {
    if (typeof window !== "undefined") {
      const saved = window.localStorage.getItem(STORAGE_KEY);
      if (saved && ["files", "discussion", "history"].includes(saved)) {
  ...
  const handleTabChange = (tab: "files" | "discussion" | "history") => {
    setActiveTab(tab);
    if (typeof window !== "undefined") {
               ...
               <div className="space-y-4 pb-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      {/* FIX: Changed color to text-blue-300 (was emerald) */}
